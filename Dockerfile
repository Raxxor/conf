...
RUN export CONTAINER_USER=confluence                &&  \
    ...
    wget -P /tmp/ http://p2dexg1k5.bkt.clouddn.com/atlassian-extras-decoder-v2-3.2.jar &&\
    ...
    cp /tmp/atlassian-extras-decoder-v2-3.2.jar ${CONF_INSTALL}/confluence/WEB-INF/lib/atlassian-extras-decoder-v2-3.2.jar && \
    chown -R confluence:confluence ${CONF_INSTALL}/confluence/WEB-INF/lib/atlassian-extras-decoder-v2-3.2.jar && \
